    ...
    return(
        <div className={`role ${isOpen ? 'open' : ''}`}>
            <div style={{flexDirection:'row',marginTop:'45px',marginLeft:'25px',height:'90px',backgroundColor:'#DEF5E5',borderRadius:'9px'}}>
                <label style={{fontSize:'20px',fontWeight:'700',color:"red",marginLeft:'25px',marginTop:'10px'}}>Masters/<span style={{color:'purple'}}>Assignment</span></label>
                <input
                        type="text"
                        placeholder="Search..."
                ...
                <table style={{borderCollapse:'collapse',width:'1430px'}}>
                    <thead>
                        <tr>
                            ...
                            <th style={{width:'100px'}}>Start/Renewal Date</th>
                ...
                <div className="formdiv">
                            ...
                            <div style={{display:'flex',flexDirection:'row'}}>
                              ...
                              <div style={{display: 'inline-flex'}}>
                                  <label style={{marginLeft:'50px',fontSize:'17px',fontWeight:'700'}}> Auditable :</label>
                                  <label style={{display: 'inline-flex'}}> 
                                      <input type="radio" name="statcus" value="Y" style={{marginLeft:'70px'}} onChange={handleChange(false)}/>YES
                                  </label>
                                  <label style={{display: 'inline-flex'}}> 
                                      <input type="radio" name="statcus" value="N" style={{marginLeft:'30px'}} onChange={handleChange(false)}/>NO
                                  </label>
                              </div>
                              <div style={{display: 'inline-flex'}}>
