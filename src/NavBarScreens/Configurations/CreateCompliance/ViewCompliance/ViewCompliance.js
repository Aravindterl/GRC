            ...
            <div className="rolemastertable">
                <table>
                    ...
                    {currentItems.map(item => (
                        ...
                        <td><FiEdit onClick={() => handleEdit(item)} size={15} style={{cursor:'pointer',marginRight:'10px',marginLeft:'10px'}}/></td>
                        </tr>
                    ))}
                    </tbody>
                </table>
...
export default ViewCompliancePeriod;